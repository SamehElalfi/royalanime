            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <h1 class="mb-5 h2" id="new-anime">
                        <span>كل أنواع الأنمي</span>
                    </h1>
                </div>
            </div>

            @foreach ($ratings as $rating)
                <a class="btn btn-lg btn-outline-primary btn-round col col-5 col-md-2" href="{{ route('rating.show', ['rating'=> $rating]) }}">{{ $rating }}</a>    
            @endforeach

            <div class="text-center">
                {{-- <i class="fa fa-frown-o" style="font-size: 10em;"></i> --}}
                <p class="lead">هذه الصفحة لا تحتوي على أي أنميات، وإنما فقط كل أنواع الأنمي التي لدينا، يمكنك مشاهدة قائمة الأنميات أو البحث في أكثر من 40.000 حلقة لدينا.</p>
