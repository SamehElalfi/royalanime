...
<div class="position-relative">
    <section class="section section-lg section-hero section-shaped">
        ...
        <div class="shape shape-style-1 bg-cover colored-bg-transparent"
            style='background: url(img/backgrounds/bg-1.webp);background-size: cover;'>
            ...
            <div class="col px-0">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 text-center">
                        ...
                        <!-- Main Sentence -->
                        <h1 class="lead text-white h2">المنزل الملكي لكل الأنمي.<br />كل ما يحتاجه الأوتاكو في مكان
                            واحد.</h1>
                        ...
                        <div class="btn-wrapper mt-5">
                            ...
                            <a href="{{ route('animes.episodes.list') }}"
                        ...
                        <!-- Secondary Sentence -->
                        <div class="mt-5">
                            <span class="text-white font-weight-bold mb-0 mr-2">صنع بكل <i
                                    class="fa fa-heart text-warning"></i> لماتبعي الأنمي.</span>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="section section-components profile-page" id="section-components">
    <div class="container">
        ...
        <div class="text-center">
            ...
            <p class="lead">
                عذرًا، لا توجد أي أنميات في الوقت الحالي. نحن نعمل على قدم وساق لإيصال المتعة لقلوبكم في أقرب وقت ممكن.
                شكرًا على تفهمكم. __ إدارة رويال أنمي
            </p>
        </div>
        @endforelse
    ...
    <div class="container py-md">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-5 mb-5 mb-lg-0">
                ...
                <p class="lead text-white mt-4">يحتوي موقع رويال أنمي على الآلاف من مسلسلات الأنمي بالإضافة إلى المئات
                    من أفلام الأنمي أيضًا. يمكنك مشاهدة وتحميل أحدث أفلام الأنمي بروابط مباشرة من هنا.</p>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <!-- Section Descrption -->
                <p class="lead">موقع رويال أنمي يحتوي على أكثر من 40.000 حلقة أنمي لأكثر من 2.000 مسلسل متنوع في أكثر من
                    35 تصنيف مختلف. كل الأنميات الموجودة في الموقع تم إنتاجها بواسطة أكبر أستديوهات الأنمي المعروفة.</p>

                <!-- Section Buttons -->
                <div class="btn-wrapper">
                    <a href="{{ route('tags.index') }}" class="btn btn-primary">مشاهدة الأنمي بحسب التصنيف</a>
                    <a href="{{ route('animes.index') }}?sortBy=score&order=DESC" target="_blank"
                        class="btn btn-default mt-3 mt-md-0">مشاهدة الأنميات بحسب التقييم</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container py-md">
        <div class="row row-grid justify-content-between align-items-center">
            <div class="col-lg-6">
                ...
                <!-- Section Title and Description-->
                <h3 class="display-3 text-white">فلتكن دائمًا على تواصل<span class="text-white">بريد إلكتروني = آخر
                        الحلقات</span></h3>
                <p class="lead text-white">لقد قمنا في رويال أنمي بتصميم برنامج خاص لإرسال رسائل لك خصيصًا، حتى تظل
                    متابع لأنمياتك المفضلة وآخر أخبارها. ضع بريدك الإلكتروني، و إختر التصنيفات التي تريد أن تصلك آخر
                    حلقاتها وأخبارها بروابط مباشرة وبدون إعلانات.</p>
                    ...
                    <div class="card bg-secondary shadow border-0 floating">
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <div class="text-center text-muted mb-4 color-primary primary ">
                                <small class="text-warning opacity-5">* بالضغط على زر الإشتراك تكون قد قبلت شروط الموقع
                                    بلا أي إستثناء</small>
                            </div>
                        </div>
                    </div>
                </div>
