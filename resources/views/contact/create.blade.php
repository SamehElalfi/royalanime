                        ...
                        <div class="card-body p-lg-5">
                            ...
                            <form action="/contact" method="post">
                                ...
                                <div class="form-group mt-5">
                                    <div
                                        class="input-group input-group-alternative {{ $errors->has('name') ? 'has-danger' : ''}}">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fa fa-user"></i></span>
                                        </div>
                                        <input class="form-control" name="name" placeholder="اسمك" type="text"
                                ...
                                <div class="form-group">
                                    <div
                                        class="input-group input-group-alternative {{ $errors->has('email') ? 'has-danger' : ''}}">
                                        <div class="input-group-prepend">
                                ...
                                <div class="form-group mb-4 {{ $errors->has('message') ? 'has-danger' : ''}}">
                                    <textarea class="form-control form-control-alternative" name="message" rows="4"
                                        cols="80" placeholder="أكتب رسالتك..." value="{{ old('message') }}"
                                        required></textarea>
                                ...
                                <div>
                                    <button type="submit"
                                        class="btn btn-default btn-round btn-block btn-lg">إرسال</button>
                                </div>
