...
@include('dashboard.users.partials.header', [
    'title' => __('dashboard.Add a new episode to an exist anime'),
    'description' => __('dashboard.Fill this form to create an episode, please note that any empty field willbe shown as unknown.'),
])   
